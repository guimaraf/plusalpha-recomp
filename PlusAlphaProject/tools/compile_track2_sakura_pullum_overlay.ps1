# compile_track2_sakura_pullum_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Sakura vs Pullum Purna)
# Alvo: Erradicacao dos Hotspots de Luta Sakura vs Pullum Purna (PL15_1 / PL14_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0xC0DC22A6
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0xC0DC22A6"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (SAKURA vs PULLUM PURNA - LOTE 7)   " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80048880, 0x80047934, 0x80093280, 0x8008EDA8" -ForegroundColor Yellow
...
$hotspots = @("80048880", "80047934", "80093280", "8008EDA8", "800493C8", "80049588")
...
Write-Host "  COMPILACAO DE TRACK 2 (SAKURA vs PULLUM) CONCLUIDA COM SUCESSO!     " -ForegroundColor Green
