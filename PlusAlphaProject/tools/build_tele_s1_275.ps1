# build_tele_s1_275.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-275
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-275",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-275            " -ForegroundColor Cyan
...
Write-Host ""
Write-Host "[+] BUILD DE TELEMETRIA S1-275 PRONTA EM: $TargetExe" -ForegroundColor Cyan
