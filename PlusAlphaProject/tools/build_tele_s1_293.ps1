# build_tele_s1_293.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-293
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-293",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-293            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-293 concluida e pronta para testes!           " -ForegroundColor Green
