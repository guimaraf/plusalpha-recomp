...
printf '======================================================================\n'
printf '        GERACAO DE FONTES - MICRO-LOTE S1-276                         \n'
printf '  Subsistema: Guile Combat Action (Sonic Boom, Flash Kick & Carga)     \n'
printf '  Orcamento: 2 funcoes novas, 295 palavras (1.180 bytes)               \n'
printf '  Meta: 1.157 funcoes nativas, 132.465 palavras (67,7284%%)            \n'
printf '======================================================================\n'
...
printf '\n[+] MICRO-LOTE S1-276 GERADO E AUDITADO COM SUCESSO!\n'
