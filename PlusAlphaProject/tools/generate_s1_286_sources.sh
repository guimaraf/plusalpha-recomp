...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-286                         "
echo "  Subsistema:  GTE Vector Math Subroutine Cluster (Hokuto)              "
echo "  Orcamento:   10 funcoes novas, 125 palavras (500 bytes)             "
echo "  Meta:        1.224 funcoes nativas, 138.481 palavras (70,8038%)     "
echo "======================================================================"
