...
printf '======================================================================\n'
printf '        GERACAO DE FONTES - MICRO-LOTE S1-272                         \n'
printf '  Raiz: 0x801202EC (Defender Hit-Stun & Damage Physics Cluster)       \n'
printf '  Orcamento: 8 funcoes novas, 726 palavras (2.904 bytes)              \n'
printf '  Meta: 1.131 funcoes nativas, 128.317 palavras (65,6071%%)           \n'
printf '======================================================================\n'
...
printf '\n[+] MICRO-LOTE S1-272 GERADO E AUDITADO COM SUCESSO!\n'
