# compile_track2_lote2_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Lote 2)
# Alvo: Erradicacao dos Hotspots de Luta Guile vs Chun-Li (PL03_1 / PL02_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0x8ADC0BC2
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0x8ADC0BC2"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host " COMPILACAO DE TRACK 2 - OVERLAY DE GAMEPLAY (GUILE vs CHUN-LI - L2) " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80092360, 0x800911D0, 0x800908EC, 0x8004626C" -ForegroundColor Yellow
...
$hotspots = @("80092360", "800911D0", "800908EC", "8004626C", "8008E430", "8004485C")
...
Write-Host "  COMPILACAO DE TRACK 2 (GUILE vs CHUN-LI) CONCLUIDA COM SUCESSO!     " -ForegroundColor Green
