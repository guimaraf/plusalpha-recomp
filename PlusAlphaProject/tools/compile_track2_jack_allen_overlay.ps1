# compile_track2_jack_allen_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Cracker Jack vs Allen Snider)
# Alvo: Erradicacao dos Hotspots de Luta Cracker Jack vs Allen Snider (PL11_1 / PL12_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0xBAAE2FE7
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0xBAAE2FE7"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (CRACKER JACK vs ALLEN SNIDER - LOTE 5)" -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80048C58, 0x80090E0C, 0x80047A80, 0x80049550" -ForegroundColor Yellow
...
$hotspots = @("80048C58", "80090E0C", "80047A80", "80049550", "8008E394", "800449AC", "80044978")
...
Write-Host "  COMPILACAO DE TRACK 2 (JACK vs ALLEN) CONCLUIDA COM SUCESSO!         " -ForegroundColor Green
