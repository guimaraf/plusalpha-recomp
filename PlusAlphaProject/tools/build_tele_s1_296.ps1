# build_tele_s1_296.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-296
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-296",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-296            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-296 concluida e pronta para testes!           " -ForegroundColor Green
