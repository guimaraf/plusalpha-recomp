# build_tele_s1_297.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-297
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-297",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-297            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-297 concluida e pronta para testes!           " -ForegroundColor Green
