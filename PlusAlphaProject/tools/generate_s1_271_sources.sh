...
printf '======================================================================\n'
printf '        GERACAO DE FONTES - MICRO-LOTE S1-271                         \n'
printf '  Raiz: 0x801288DC (Special Move Physics & Vector Cluster)            \n'
printf '  Orcamento: 3 funcoes novas, 89 palavras (356 bytes)                 \n'
printf '  Meta: 1.123 funcoes nativas, 127.591 palavras (65,2359%%)           \n'
printf '======================================================================\n'
...
printf '\n[+] MICRO-LOTE S1-271 GERADO E AUDITADO COM SUCESSO!\n'
