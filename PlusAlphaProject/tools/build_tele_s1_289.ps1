# build_tele_s1_289.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-289
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-289",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-289            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-289 concluida e pronta para testes!           " -ForegroundColor Green
