# compile_track2_pl00_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Lote 1)
# Alvo: Erradicacao dos Hotspots de Luta Ryu vs Ken (PL00_1 / PL01_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0xDE842D4E
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0xDE842D4E"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "   COMPILACAO DE TRACK 2 - OVERLAY DE GAMEPLAY (RYU vs KEN - LOTE 1)  " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80091B4C, 0x8004B154, 0x8008E924, 0x80045480" -ForegroundColor Yellow
...
$hotspots = @("80091B4C", "8004B154", "8008E924", "80045480", "800922A0", "8008EBB0", "8004B8A8", "8008E19C")
...
Write-Host "  COMPILACAO DE TRACK 2 (RYU vs KEN) CONCLUIDA COM SUCESSO!           " -ForegroundColor Green
