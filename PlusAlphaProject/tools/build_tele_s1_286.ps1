# build_tele_s1_286.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-286
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-286",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-286            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-286 concluida e pronta para testes!           " -ForegroundColor Green
