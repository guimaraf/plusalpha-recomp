...
printf '======================================================================\n'
printf '        GERACAO DE FONTES - MICRO-LOTE S1-275                         \n'
printf '  Subsistemas: Combat Action (Carga/Hold) & Overlay Support Leaf       \n'
printf '  Orcamento: 10 funcoes novas, 840 palavras (3.360 bytes)              \n'
printf '  Meta: 1.155 funcoes nativas, 132.170 palavras (67,5771%%)            \n'
printf '======================================================================\n'
...
printf '\n[+] MICRO-LOTE S1-275 GERADO E AUDITADO COM SUCESSO!\n'
