# build_tele_s1_302.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-302
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-302",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-302            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-302 concluida e pronta para testes!           " -ForegroundColor Green
