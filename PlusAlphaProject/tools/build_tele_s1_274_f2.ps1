# build_tele_s1_274_f2.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-274-f2
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-274-f2",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-274 (F2)       " -ForegroundColor Cyan
...
cd /d "%~dp0"
echo ======================================================================
echo   Iniciando Street Fighter EX Plus Alpha [buildTele-s1-274-f2]
...
Write-Host "  [+] BUILD TELEMETRIA S1-274 (F2) GERADA COM SUCESSO!" -ForegroundColor Green
