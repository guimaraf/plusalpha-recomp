# build_tele_s1_278.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-278
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-278",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-278            " -ForegroundColor Cyan
...
if (-not (Test-Path $RefDir)) {
    $RefDir = Join-Path $ProjectRoot "buildTele-s1-276"
}
if (Test-Path $RefDir) {
...
Write-Host " Build de Telemetria S1-278 pronta para execucao.                     " -ForegroundColor Green
Write-Host "======================================================================" -ForegroundColor Green
