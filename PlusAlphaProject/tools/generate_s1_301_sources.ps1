# generate_s1_301_sources.ps1
# Geracao de fontes e auditoria formal do Micro-Lote S1-301
[CmdletBinding()]
param(
...
Write-Host "        GERACAO DE FONTES - MICRO-LOTE S1-301                         " -ForegroundColor Cyan
Write-Host "  Subsistema:  Pipeline de Armas/Props (Renderizador 3D da Adaga)     " -ForegroundColor Yellow
Write-Host "  Orcamento:   1 funcao nova, 266 palavras (1.064 bytes)              " -ForegroundColor Yellow
Write-Host "  Meta:        1.303 funcoes nativas, 144.059 palavras (73,6558%)     " -ForegroundColor Yellow
Write-Host "======================================================================" -ForegroundColor Cyan
...
print(f"[OK] Cluster S1-301 validado com sucesso: 1.303 funcoes, {total_words} palavras (73.6558%).")
'@
    ...
    Write-Host " Fontes de S1-301 gerados e auditados com SUCESSO!                    " -ForegroundColor Green
    Write-Host "======================================================================" -ForegroundColor Green
}
finally {
    Pop-Location
