# build_tele_s1_270.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-270
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-270",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-270 (F1+F2)    " -ForegroundColor Cyan
