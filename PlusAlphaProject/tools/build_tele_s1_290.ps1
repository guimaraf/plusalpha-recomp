# build_tele_s1_290.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-290
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-290",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-290            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-290 concluida e pronta para testes!           " -ForegroundColor Green
