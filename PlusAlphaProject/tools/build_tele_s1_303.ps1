# build_tele_s1_303.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-303
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-303",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-303            " -ForegroundColor Cyan
...
Write-Host " Build de Telemetria S1-303 concluida com SUCESSO!                    " -ForegroundColor Green
