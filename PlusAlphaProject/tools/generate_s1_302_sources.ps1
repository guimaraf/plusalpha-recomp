# generate_s1_302_sources.ps1
# Geracao de fontes e auditoria formal do Micro-Lote S1-302
[CmdletBinding()]
param(
...
Write-Host "        GERACAO DE FONTES - MICRO-LOTE S1-302                         " -ForegroundColor Cyan
Write-Host "  Subsistema:  Pipeline de Armas/Props (Despachador e Variante ID 25) " -ForegroundColor Yellow
Write-Host "  Orcamento:   2 funcoes novas, 330 palavras (1.320 bytes)            " -ForegroundColor Yellow
Write-Host "  Meta:        1.305 funcoes nativas, 144.389 palavras (73,8245%)     " -ForegroundColor Yellow
Write-Host "======================================================================" -ForegroundColor Cyan
...
print(f"[OK] Cluster S1-302 validado com sucesso: 1.305 funcoes, {total_words} palavras (73.8245%).")
'@
    ...
    Write-Host " Fontes de S1-302 gerados e auditados com SUCESSO!                    " -ForegroundColor Green
    Write-Host "======================================================================" -ForegroundColor Green
}
finally {
    Pop-Location
