# build_tele_s1_288.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-288
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-288",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-288            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-288 concluida e pronta para testes!           " -ForegroundColor Green
