...
Write-Host "        GERACAO DE FONTES - MICRO-LOTE S1-270 (FRENTES 1 & 2)         " -ForegroundColor Cyan
Write-Host "  Frente 1:   0x8019E6D0 (3D Trigonometry & Matrix Rotation Leaf)     " -ForegroundColor Yellow
Write-Host "  Frente 2:   0x80160B54..0x80160F94 (Reaction/Collision Cluster)     " -ForegroundColor Yellow
Write-Host "  Orcamento:  6 funcoes novas (+5 Frente 2), 374 palavras (+272)      " -ForegroundColor Yellow
Write-Host "======================================================================" -ForegroundColor Cyan
...
print(f"[OK] Manifest validado com sucesso: {len(funcs)} funcoes, {total_words} palavras (65.1904% de cobertura estatica).")
'@
    ...
    Write-Host ""
    Write-Host "[+] MICRO-LOTE S1-270 (FRENTE 1) GERADO E AUDITADO COM SUCESSO!" -ForegroundColor Cyan
}
finally {
    Pop-Location
}
