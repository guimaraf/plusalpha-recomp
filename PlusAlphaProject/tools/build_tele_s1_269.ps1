# build_tele_s1_269.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-269
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-269",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-269            " -ForegroundColor Cyan
...
cd /d "%~dp0"
echo ======================================================================
echo   Iniciando Street Fighter EX Plus Alpha [buildTele-s1-269]
...
Write-Host "  [+] BUILD TELEMETRIA S1-269 GERADA COM SUCESSO!" -ForegroundColor Green
