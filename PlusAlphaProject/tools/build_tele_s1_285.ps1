# build_tele_s1_285.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-285
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-285",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-285            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-285 concluida e pronta para testes!           " -ForegroundColor Green
