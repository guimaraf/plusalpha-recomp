# build_tele_s1_299.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-299
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-299",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-299            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-299 concluida e pronta para testes!           " -ForegroundColor Green
