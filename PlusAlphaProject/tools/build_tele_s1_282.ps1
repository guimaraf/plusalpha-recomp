# build_tele_s1_282.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-282
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-282",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-282            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-282 concluida e pronta para testes!           " -ForegroundColor Green
