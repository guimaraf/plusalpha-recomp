# build_tele_s1_304.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-304
[CmdletBinding()]
param(
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-304            " -ForegroundColor Cyan
...
Write-Host " Build de Telemetria S1-304 concluida com SUCESSO!                    " -ForegroundColor Green
