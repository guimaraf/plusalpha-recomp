# build_tele_s1_298.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-298
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-298",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-298            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-298 concluida e pronta para testes!           " -ForegroundColor Green
