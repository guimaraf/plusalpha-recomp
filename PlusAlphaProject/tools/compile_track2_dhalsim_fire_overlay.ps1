# compile_track2_dhalsim_fire_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Motor de Fogo do Dhalsim)
# Alvo: Erradicacao dos Hotspots de Chamas, Yoga Inferno e Efeitos de Queimadura (PL05_1 / Dhalsim)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0x17DBBA46
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0x17DBBA46"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (DHALSIM FIRE ENGINE - LOTE 12)     " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80049FA0, 0x8004A254, 0x80049A14, 0x8004B5E4" -ForegroundColor Yellow
Write-Host "  Subsistemas Cobertos: Yoga Flame, Yoga Blast, Yoga Inferno e Queima " -ForegroundColor Yellow
...
# Validar cobertura dos top hotspots do motor de fogo
$hotspots = @("80049FA0", "8004A254", "80049A14", "8004A1B0", "8004B5E4", "8004A8B8", "80048EBC", "8004ACF4")
...
Write-Host "  COMPILACAO DE TRACK 2 (MOTOR DE FOGO DHALSIM) CONCLUIDA!            " -ForegroundColor Green
Write-Host "  O executavel '$BuildDirName\exPlusAlpha.exe' carregara              " -ForegroundColor Green
Write-Host "  automaticamente as novas DLLs de chamas durante o gameplay.         " -ForegroundColor Green
Write-Host "======================================================================" -ForegroundColor Cyan
