# compile_track2_cycloidgamma_beta_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Cycloid-Gamma vs Cycloid-Beta)
# Alvo: Erradicacao dos Hotspots de Combate e Teleporte Poligonal (PL22_1 / PL21_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0xF3461917
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0xF3461917"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (CYCLOID-GAMMA vs CYCLOID-BETA)     " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x8004880C, 0x80048930, 0x80045410, 0x80045478" -ForegroundColor Yellow
Write-Host "  Subsistemas Cobertos: Combate, Teleporte e Moveset Poligonal Dourado" -ForegroundColor Yellow
...
$hotspots = @("8004880C", "80048930", "80044E90", "80045410", "80045478", "80044FE0", "8004523C")
...
Write-Host "  COMPILACAO DE TRACK 2 (CYCLOID-G vs CYCLOID-B) CONCLUIDA!           " -ForegroundColor Green
