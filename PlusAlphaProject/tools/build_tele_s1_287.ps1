# build_tele_s1_287.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-287
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-287",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-287            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-287 concluida e pronta para testes!           " -ForegroundColor Green
