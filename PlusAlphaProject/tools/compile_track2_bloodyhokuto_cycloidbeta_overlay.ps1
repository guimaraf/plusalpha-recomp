# compile_track2_bloodyhokuto_cycloidbeta_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Bloody Hokuto vs Cycloid-Beta)
# Alvo: Erradicacao dos Hotspots Residuais de Combate e Props (PL20_1 / PL21_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0x516F48AF
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0x516F48AF"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (BLOODY HOKUTO vs CYCLOID-BETA)     " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80049AF0, 0x8008EE40, 0x80092028, 0x8008ECB4" -ForegroundColor Yellow
Write-Host "  Subsistemas Cobertos: Combate, Adagas/Props e Moveset Poligonal     " -ForegroundColor Yellow
...
$hotspots = @("80049AF0", "8008EE40", "80092028", "8008ECB4", "8004B720", "8004508C", "80044E60")
...
Write-Host "  COMPILACAO DE TRACK 2 (BLOODY HOKUTO vs CYCLOID-B) CONCLUIDA!       " -ForegroundColor Green
