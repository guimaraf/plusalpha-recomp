# build_tele_s1_284.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-284
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-284",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-284            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-284 concluida e pronta para testes!           " -ForegroundColor Green
