...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-278                         "
echo "  Subsistema:  Status Dispatcher & Combat Vector Transition Cluster    "
echo "  Orcamento:   3 funcoes novas, 223 palavras (892 bytes)              "
echo "  Meta:        1.169 funcoes nativas, 133.918 palavras (68,4708%)     "
echo "======================================================================"
