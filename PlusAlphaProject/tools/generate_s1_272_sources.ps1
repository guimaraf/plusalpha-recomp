...
Write-Host "        GERACAO DE FONTES - MICRO-LOTE S1-272                         " -ForegroundColor Cyan
Write-Host "  Raiz:       0x801202EC (Defender Hit-Stun & Damage Physics Cluster)" -ForegroundColor Yellow
Write-Host "  Orcamento:  8 funcoes novas, 726 palavras (2.904 bytes)             " -ForegroundColor Yellow
Write-Host "  Meta:       1.131 funcoes nativas, 128.317 palavras (65,6071%)      " -ForegroundColor Yellow
Write-Host "======================================================================" -ForegroundColor Cyan
...
print(f"[OK] Manifest validado com sucesso: {len(funcs)} funcoes, {total_words} palavras (65.6071% de cobertura estatica).")
'@
    ...
    Write-Host ""
    Write-Host "[+] MICRO-LOTE S1-272 GERADO E AUDITADO COM SUCESSO!" -ForegroundColor Cyan
}
finally {
    Pop-Location
}
