# build_tele_s1_291.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-291
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-291",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-291            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-291 concluida e pronta para testes!           " -ForegroundColor Green
