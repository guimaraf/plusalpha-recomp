# build_tele_s1_280.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-280
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-280",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-280            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-280 concluida e pronta para testes!           " -ForegroundColor Green
