# build_tele_s1_307.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-307
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-307",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-307            " -ForegroundColor Cyan
...
Write-Host " Build de Telemetria S1-307 concluida com SUCESSO!                    " -ForegroundColor Green
