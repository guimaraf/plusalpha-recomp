...
# Automacao de compilacao da build isolada de telemetria buildTele-s1-268
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-268",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-268            " -ForegroundColor Cyan
