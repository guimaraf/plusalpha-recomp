# compile_track2_zangief_dhalsim_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Zangief vs Dhalsim)
# Alvo: Erradicacao dos Hotspots de Luta Zangief vs Dhalsim (PL04_1 / PL05_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0xF0CC3CB1
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0xF0CC3CB1"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (ZANGIEF vs DHALSIM - LOTE 2 PARTE B)" -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x800939A0, 0x80093C54, 0x80093414, 0x80093BB0" -ForegroundColor Yellow
...
$hotspots = @("800939A0", "80093C54", "80093414", "80093BB0", "800928BC", "80094FE4")
...
Write-Host "  COMPILACAO DE TRACK 2 (ZANGIEF vs DHALSIM) CONCLUIDA COM SUCESSO!   " -ForegroundColor Green
