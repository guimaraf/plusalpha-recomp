# build_tele_s1_272.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-272
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-272",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-272            " -ForegroundColor Cyan
