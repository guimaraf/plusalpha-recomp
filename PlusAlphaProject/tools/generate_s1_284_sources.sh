...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-284                         "
echo "  Subsistema:  Movement & Sliding Subroutines (Blair Dame)             "
echo "  Orcamento:   3 funcoes novas, 366 palavras (1.464 bytes)            "
echo "  Meta:        1.208 funcoes nativas, 137.409 palavras (70,2557%)     "
echo "======================================================================"
