# build_tele_s1_295.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-295
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-295",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-295            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-295 concluida e pronta para testes!           " -ForegroundColor Green
