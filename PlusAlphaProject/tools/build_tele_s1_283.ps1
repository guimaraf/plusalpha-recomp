# build_tele_s1_283.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-283
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-283",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-283            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-283 concluida e pronta para testes!           " -ForegroundColor Green
