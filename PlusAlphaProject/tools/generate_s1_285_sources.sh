...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-285                         "
echo "  Subsistema:  Acrobatic Action, Trajectory & Combat (Skullomania)      "
echo "  Orcamento:   6 funcoes novas, 947 palavras (3.788 bytes)            "
echo "  Meta:        1.214 funcoes nativas, 138.356 palavras (70,7400%)     "
echo "======================================================================"
