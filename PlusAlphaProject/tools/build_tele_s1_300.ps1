# build_tele_s1_300.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-300
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-300",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-300            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-300 concluida e pronta para testes!           " -ForegroundColor Green
