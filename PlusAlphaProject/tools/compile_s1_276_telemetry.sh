...
readonly BUILD_DIR="$PROJECT_ROOT/buildTele-s1-276"
...
printf '======================================================================\n'
printf '     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-276            \n'
printf '  Alvo: buildTele-s1-276                                              \n'
...
if [[ ! -d "$BUILD_DIR" ]]; then
    printf '[+] Configurando novo diretorio de buildTele-s1-276...\n'
...
if [[ -f "$TARGET_EXE" ]]; then
    printf '\n[+] BUILD DE TELEMETRIA S1-276 CONCLUIDA COM SUCESSO!\n'
