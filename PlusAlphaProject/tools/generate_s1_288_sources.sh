...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-288                         "
echo "  Subsistema:  Boot Sequence & Attract/Demo Presentation Pipeline     "
echo "  Orcamento:   8 funcoes novas, 972 palavras (3.888 bytes)            "
echo "  Meta:        1.241 funcoes nativas, 140.233 palavras (71,6996%)     "
echo "======================================================================"
