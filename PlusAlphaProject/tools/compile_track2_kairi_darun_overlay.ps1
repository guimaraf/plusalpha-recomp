# compile_track2_kairi_darun_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Kairi vs Darun Mister)
# Alvo: Erradicacao dos Hotspots de Luta Kairi vs Darun Mister (PL08_1 / PL13_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0xFC0AD63C
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0xFC0AD63C"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (KAIRI vs DARUN MISTER - LOTE 6)    " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80048190, 0x8008E164, 0x80091108, 0x800448D8" -ForegroundColor Yellow
...
$hotspots = @("80048190", "8008E164", "80091108", "800448D8", "80044F50", "80044C10", "80044D60")
...
Write-Host "  COMPILACAO DE TRACK 2 (KAIRI vs DARUN) CONCLUIDA COM SUCESSO!        " -ForegroundColor Green
