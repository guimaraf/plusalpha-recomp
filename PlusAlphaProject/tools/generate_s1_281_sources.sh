...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-281                         "
echo "  Subsistema:  Action Dispatcher Subsystem (Blair & Zangief)           "
echo "  Orcamento:   5 funcoes novas, 612 palavras (2.448 bytes)            "
echo "  Meta:        1.195 funcoes nativas, 135.871 palavras (69,4693%)     "
echo "======================================================================"
