# build_tele_s1_281.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-281
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-281",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-281            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-281 concluida e pronta para testes!           " -ForegroundColor Green
