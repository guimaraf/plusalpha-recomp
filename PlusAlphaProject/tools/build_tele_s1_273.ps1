# build_tele_s1_273.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-273
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-273",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-273            " -ForegroundColor Cyan
...
cd /d "%~dp0"
echo ======================================================================
echo   Iniciando Street Fighter EX Plus Alpha [buildTele-s1-273]
...
Write-Host "  [+] BUILD TELEMETRIA S1-273 GERADA COM SUCESSO!" -ForegroundColor Green
