# build_tele_s1_276.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-276
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-276",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-276            " -ForegroundColor Cyan
...
Write-Host ""
Write-Host "[+] BUILD DE TELEMETRIA S1-276 PRONTA EM: $TargetExe" -ForegroundColor Cyan
