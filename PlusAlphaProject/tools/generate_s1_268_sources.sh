...
printf '======================================================================\n'
printf '        GERACAO DE FONTES - MICRO-LOTE S1-268                         \n'
printf '  Raiz: 0x80117224 (Entity / Frame Processing Cluster)                \n'
printf '  Orcamento: 4 funcoes novas, 459 palavras (1.836 bytes)              \n'
printf '======================================================================\n'
...
print(f"[OK] Manifest validado com sucesso: {len(funcs)} funcoes, {total_words} palavras (64.8468% de cobertura estatica).")
EOF

printf '[3/3] Executando auditoria formal do codigo C gerado (codegen audit)...\n'
"$PYTHON_BIN" "$AUDIT_SCRIPT" --config "$CONFIG_PATH"

printf '\n[+] MICRO-LOTE S1-268 GERADO E AUDITADO COM SUCESSO!\n'
