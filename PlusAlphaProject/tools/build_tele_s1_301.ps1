# build_tele_s1_301.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-301
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-301",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-301            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-301 concluida e pronta para testes!           " -ForegroundColor Green
