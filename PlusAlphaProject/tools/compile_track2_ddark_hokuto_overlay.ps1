# compile_track2_ddark_hokuto_overlay.ps1
# Automacao de compilacao dos Shards Dinamicos de Gameplay / Combate (Track 2 - Doctrine Dark vs Hokuto)
# Alvo: Erradicacao dos Hotspots de Luta Doctrine Dark vs Hokuto (PL07_1 / PL06_1)
# Modulo: 0x80020000..0x800F2000 (840 KB) -> Capture Key: 0x00020000:0x7113C787
[CmdletBinding()]
param(
...
$CaptureKey = "0x00020000:0x7113C787"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "  COMPILACAO DE TRACK 2 - OVERLAY (DOCTRINE DARK vs HOKUTO - LOTE 3)  " -ForegroundColor Cyan
...
Write-Host "  Top Hotspots Alvo:    0x80093428, 0x80047EFC, 0x8008E798, 0x80047DE8" -ForegroundColor Yellow
...
$hotspots = @("80093428", "80047EFC", "8008E798", "80049808", "80047DE8", "80044C7C", "80093B08", "80044830")
...
Write-Host "  COMPILACAO DE TRACK 2 (DOCTRINE DARK vs HOKUTO) CONCLUIDA COM SUCESSO! " -ForegroundColor Green
