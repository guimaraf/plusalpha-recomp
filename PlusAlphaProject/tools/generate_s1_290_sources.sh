...
echo "======================================================================"
echo "        GERACAO DE FONTES - MICRO-LOTE S1-290                         "
echo "  Subsistema:  Cluster 2 - Training Stage 3D Grid & Camera            "
echo "  Orcamento:   3 funcoes novas, 617 palavras (2.468 bytes)            "
echo "  Meta:        1.247 funcoes nativas, 141.053 palavras (72,1188%)     "
echo "======================================================================"
