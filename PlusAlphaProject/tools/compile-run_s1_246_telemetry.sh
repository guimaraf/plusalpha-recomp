...
Uso, sempre no MSYS2 UCRT64:
  ...
  bash tools/compile-run_s1_246_telemetry.sh

Configura e compila a build isolada S1-246 de telemetria. Ao final, confere
a raiz indireta de Doctrine Dark, a auxiliar e as DLLs importadas. Este script
nao abre o jogo.
EOF
}
...
validate_environment() {
    ...
    [[ -f "$RANGES_FILE" ]] || fail "Ranges S1-246 ausentes: $RANGES_FILE"
    require_range "F 8011D030"; require_range "R 8011D030 48"; require_range "F 8011D078"; require_range "R 8011D078 298"; require_range "F 8011D310"; require_range "F 801171DC"; require_range "F 80107A74"; require_range "F 80162D68"; require_range "F 80137FE8"; require_range "F 80138084"; require_range "F 8013827C"; require_range "F 801102A0"; require_range "F 8013CB08"
