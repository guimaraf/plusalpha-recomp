# build_tele_s1_294.ps1
# Automacao de compilacao da build isolada de telemetria buildTele-s1-294
[CmdletBinding()]
param(
    [string]$BuildDirName = "buildTele-s1-294",
...
Write-Host "     COMPILACAO DA BUILD DE TELEMETRIA - MICRO-LOTE S1-294            " -ForegroundColor Cyan
...
Write-Host " Build de telemetria S1-294 concluida e pronta para testes!           " -ForegroundColor Green
